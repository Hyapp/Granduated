...
<\body>
  ...
  <\definition>
    ...
    <\equation*>
      <tabular*|<tformat|<table|<row|<cell|广群groupid>|<cell|非空集S和S上的二元运算\<mu\>:<around*|(|S\<times\>S\<rightarrow\>S|)>>>|<row|<cell|半群semigroup>|<cell|\<forall\>x,y,z\<in\>S,\<mu\>具有结合律：<around*|(|<around*|(|x,y|)>\<mu\>,z|)>\<mu\>>>>>>
    </equation*>
  </definition>
  ...
  <\notation>
    群的基数：群元素集合的基数（the order of S）
  </notation>

  <\definition>
    交换半群(Commutative semigroup)：(阿贝尔半群 abelian)
  ...
  <\definition>
    ...
    <\equation*>
      <tabular*|<tformat|<table|<row|<cell|单位元<around*|(|identity
      element|)>>|<cell|\<exists\>1\<in\>S,\<forall\>x\<in\>S,1 x=x
      1=x>>|<row|<cell|幺半群<around*|(|monoid|)>>|<cell|含有单位元的半群>>>>>
    </equation*>
  </definition>
  ...
  <\definition>
    ...
    <\equation*>
      <tabular*|<tformat|<table|<row|<cell|对于没有单位元的半群S，向S添加单位元1>|<cell|>>|<row|<cell|满足：\<forall\>s\<in\>S,1
      s=s 1=s;1\<cdot\>1=1>|<cell|>>|<row|<cell|S<rsup|1>=S\<cup\><around*|{|1|}>>|<cell|>>|<row|<cell|此时S<rsup|1>是monoid>|<cell|待证？？？>>|<row|<cell|定义：S<rsup|1>是S的生成幺半群>|<cell|>>>>>
    </equation*>
  ...
  <\remark>
    trivial：只有一个元素的半群.<math|<around*|{|e|}>:e<rsup|2>=e>.此时<math|e>既是0元也是1元
  </remark>
  ...
  <\definition>
    ...
    <\equation*>
      <tabular*|<tformat|<table|<row|<cell|0\<nin\>S.向S中添加元素0>>|<row|<cell|满足：\<forall\>s\<in\>S,0s=s0=00=0>>|<row|<cell|S<rsup|0>=S\<cup\><around*|{|0|}>>>|<row|<cell|定义：S<rsup|0>是S的零元扩张>>>>>
    </equation*>
  </definition>

  <\remark>
    向半群中添加元素看似容易，实质上对性质有巨大影响。不能简化研究半群的性质等同于含有0、1
    的半群的性质。

    例：向群中添加一个零元，得到的仅仅是一个半群而不是群。
  </remark>

  <\definition>
    左、右零半群(left/right zero semigroup)

    <\equation*>
      <tabular*|<tformat|<table|<row|<cell|>|<cell|非空半群S>>|<row|<cell|左零半群>|<cell|\<forall\>a,b\<in\>S,a
      b=a>>|<row|<cell|右零半群>|<cell|\<forall\>a,b\<in\>S,b a=a>>>>>
    </equation*>
  </definition>

  <\example>
    闭区间<math|<around*|[|0,1|]>>上的全体元素和乘法<math|\<times\>:x
    y=min<around*|(|x,y|)>>构成半群S.
  </example>
  ...
  <\definition>
    ...
    <\equation*>
      <tabular*|<tformat|<table|<row|<cell|定义>|<cell|A,B\<subset\>S.A
      B\<assign\><around*|{|a b:a\<in\>A\<wedge\>b\<in\>B|}>>>|<row|<cell|定义>|<cell|a\<in\>S,A\<subset\>S.
      a A=<around*|{|a|}>A>>|<row|<cell|性质>|<cell|<around*|(|A
      B|)>C=A<around*|(|B C|)>>>|<row|<cell|惯例>|<cell|A A=A<rsup|2>>>>>>
    </equation*>
  </definition>
  ...
  <\example>
    ...
    <\equation*>
      ...
      S<rsup|1>,S<rsup|1>a S<rsup|1>都是S的子集，它们都不含1元>>>>>
    </equation*>
  </example>

  <\definition>
    <label|def group>群(group)。三等价定义

    <\equation*>
      <tabular*|<tformat|<table|<row|<cell|群>|<cell|半群S\<wedge\>\<forall\>a\<in\>S,a
      S=S\<wedge\>S a=S>>|<row|<cell|群>|<cell|半群S\<wedge\><choice|<tformat|<table|<row|<cell|\<exists\>e\<in\>S,\<forall\>a\<in\>S,e
      a=a>>|<row|<cell|\<forall\>a\<in\>S,\<exists\>a<rsup|-1>\<in\>S,a<rsup|-1>a=e>>>>>>>>>>
    </equation*>

    定义一的等价定义：

    <\equation*>
      <tabular*|<tformat|<table|<row|<cell|群>|<cell|半群S,<around*|(|\<forall\>a,b\<in\>S|)><around*|(|\<exists\>x,y\<in\>S|)>a
      x=b\<wedge\>y a=b>>>>>
    </equation*>
    ...
    <\proof>
      ...
      <\equation*>
        <tabular*|<tformat|<table|<row|<cell|>|<cell|S a=S=a
        S>>|<row|<cell|\<Rightarrow\>>|<cell|\<exists\>b<rsub|1>\<in\>S\<rightarrow\>b
        a=a>>|<row|<cell|\<Rightarrow\>>|<cell|b是a的左单位元>>|<row|<cell|\<Rightarrow\>>|<cell|\<forall\>x\<in\>S,a
        x=b<rsub|1> a x=b<rsub|1><around*|(|a
        x|)>>>|<row|<cell|\<Rightarrow\>>|<cell|b<rsub|1>是a
        x的左单位元>>|<row|<cell|>|<cell|a
        S=S>>|<row|<cell|\<Rightarrow\>>|<cell|b<rsub|1>是S的左单位元>>|<row|<cell|>|<cell|同理>>|<row|<cell|>|<cell|\<exists\>b<rsub|2>是S的右单位元>>|<row|<cell|>|<cell|b<rsub|1>=b<rsub|1>b<rsub|2>=b<rsub|2>>>|<row|<cell|\<Rightarrow\>>|<cell|b是S的单位元>>|<row|<cell|>|<cell|>>|<row|<cell|>|<cell|a
        S=S>>|<row|<cell|\<Rightarrow\>>|<cell|\<exists\>b\<in\>S\<rightarrow\>b
        a=e\<assign\>b=a<rsup|-1>>>|<row|<cell|>|<cell|b<rsub|1>=b<rsub|1><around*|(|a
        b<rsub|2>|)>=<around*|(|b<rsub|1>a|)>b<rsub|2>=b<rsub|2>>>>>>
      </equation*>

      2<math|\<rightarrow\>>1

      <\equation*>
        <tabular*|<tformat|<table|<row|<cell|>|<cell|\<forall\>y\<in\>S, y=a
        a<rsup|-1>y>>|<row|<cell|\<Rightarrow\>>|<cell|a<around*|{|a<rsup|-1>S|}>=S>>|<row|<cell|\<Rightarrow\>>|<cell|S\<subseteq\>a
        S>>|<row|<cell|>|<cell|封闭性S<rsup|2>\<rightarrow\>S>>|<row|<cell|\<Rightarrow\>>|<cell|a
        S\<subseteq\>S>>|<row|<cell|>|<cell|同理>>|<row|<cell|\<Rightarrow\>>|<cell|a
        S=S>>>>>
      </equation*>
  ...
  <\definition>
    ...
    <\equation*>
      群G. G<rsup|0>=G\<cup\><around*|{|0|}>
    </equation*>
  </definition>

  <\proposition>
    半群S,<math|S\<cup\><around*|{|0|}>>是0-群当且仅当<math|<around*|(|\<forall\>a\<in\>S\\<around*|{|0|}>|)>,a
    S=S\<wedge\>S a=S>

    <\proof>
      <math|S=G<rsup|0>\<rightarrow\>G is \ \<up-a\> group.>

      <\equation*>
        <tabular*|<tformat|<table|<row|<cell|设S是G<rsup|0>=G\<cup\><around*|{|0|}>.
        a\<in\>G=S\\<around*|{|0|}>>>|<row|<cell|<choice|<tformat|<table|<row|<cell|a
        G=G =G a>>|<row|<cell|a 0=0=0a>>>>>\<Rightarrow\>a S=S\<wedge\>S
        a=S>>>>>
      </equation*>

      <math|\<forall\>a\<neq\>0,a S=S a=S\<rightarrow\>S是G<rsup|0>>

      <\equation*>
        <tabular*|<tformat|<table|<row|<cell|设\<forall\>a\<in\>S\\<around*|{|0|}>.
        \ a S=S\<wedge\>S a=S>|<cell|>>|<row|<cell|S隐含至少两个元素\<rightarrow\>G\<neq\>\<varnothing\>>|<cell|>>|<row|<cell|假设G=S-<around*|{|0|}>的乘法不封闭>|<cell|>>|<row|<cell|\<exists\>a,b\<in\>G\<rightarrow\>a
        b=0>|<cell|>>|<row|<cell|S<rsup|2>=<around*|(|S a|)><around*|(|b
        S|)>=S<around*|(|a b|)>S=S 0S=<around*|{|0|}>>|<cell|>>|<row|<cell|\<rightarrow\>S=a
        S\<subseteq\>S<rsup|2>=<around*|{|0|}>这与假定不符>|<cell|>>|<row|<cell|G对乘法封闭>|<cell|>>|<row|<cell|根据性质.\<forall\>a,b\<in\>G.
        \<exists\>x,y\<in\>S\<rightarrow\>a x=b\<wedge\>y
        a=b>|<cell|注意从属关系>>|<row|<cell|x,y\<neq\>0\<rightarrow\>x,y\<in\>G>|<cell|>>|<row|<cell|\<rightarrow\>G是群>|<cell|<reference|def
        group>>>>>>
      </equation*>
    </proof>
  </proposition>
  ...
  <\definition>
    ...
    <\equation*>
      <tabular*|<tformat|<table|<row|<cell|定义>|<cell|半群的非空子集，对乘法封闭>>|<row|<cell|等价二逻辑>|<cell|<choice|<tformat|<table|<row|<cell|T\<subset\>S,\<forall\>x,y\<in\>T\<rightarrow\>x
  ...
  <\theorem>
    半群S的非空子集T是S的子半群<math|\<Leftrightarrow\>\<forall\>a\<in\>T\<rightarrow\><around*|(|a
    T=T\<wedge\>T a=T|)>>
  </theorem>

  <\definition>
    理想、左/右理想(ideal)，<math|A\<neq\>\<varnothing\>>

    <\equation*>
      <tabular*|<tformat|<table|<row|<cell|左理想>|<cell|A\<subset\>S,A\<neq\>\<varnothing\>,S
      A\<subseteq\>A>>|<row|<cell|右理想>|<cell|A\<subset\>S,A\<neq\>\<varnothing\>,A
      S\<subseteq\>A>>|<row|<cell|理想>|<cell|A是左理想\<wedge\>右理想>>>>>
    </equation*>

    <\remark>
      理想(无论左右)是子半群，子半群不一定是理想
    </remark>

    显然<math|<around*|{|0|}>与S都是S的理想。理想I满足<around*|{|0|}>\<subsetneq\>I\<subsetneq\>S称为真理想>
  </definition>

  <\definition>
    态射(morphism<space|1em>同态(homomorphism))

    <\equation*>
      <tabular*|<tformat|<table|<row|<cell|映射\<phi\>:S\<rightarrow\>T.<around*|(|S,.|)><around*|(|T,.|)>都是半群>>|<row|<cell|<around*|(|x
      y|)>\<phi\>=<around*|(|x\<phi\>|)><around*|(|y\<phi\>|)>>>>>>
    </equation*>

    若<math|S,T>都是monoid<math|,\<phi\>是态射\<rightarrow\>1<rsub|S>\<phi\>=1<rsub|T>>

    <\proof>
      \;

      <\equation*>
        <tabular*|<tformat|<table|<row|<cell|>|<cell|\<phi\>是态射>>|<row|<cell|\<Rightarrow\>>|<cell|\<forall\>s\<in\>S,s\<phi\>=<around*|(|1<rsub|S>s|)>\<phi\>=<around*|(|s1<rsub|S>|)>\<varphi\>=<around*|(|1<rsub|S>|)>\<phi\><around*|(|s|)>\<phi\>=<around*|(|s|)>\<phi\><around*|(|1<rsub|S>|)>\<phi\>>>|<row|<cell|\<Rightarrow\>>|<cell|<around*|(|1<rsub|S>|)>\<phi\>=id<rsub|range
        \ \ \<phi\>>>>|<row|<cell|>|<cell|>>|<row|<cell|>|<cell|\<forall\>r<rsub|1>,r<rsub|2>\<in\>range
        \<phi\>>>|<row|<cell|\<Rightarrow\>>|<cell|r<rsub|1>r<rsub|2>=<around*|(|s<rsub|1>|)>\<phi\><around*|(|s<rsub|2>|)>\<phi\>=<around*|(|s<rsub|1>s<rsub|2>|)>\<phi\>\<in\>range
        \<phi\>>>|<row|<cell|\<Rightarrow\>>|<cell|range
        \<phi\>具有封闭性>>|<row|<cell|\<Rightarrow\>>|<cell|range
        \<phi\>是半群>>|<row|<cell|>|<cell|1<rsub|S>\<phi\>\<in\>range
        \<phi\>>>|<row|<cell|\<Rightarrow\>>|<cell|range
        \<phi\>是monoid>>|<row|<cell|>|<cell|>>|<row|反证|<cell|设1<rsub|S>\<phi\>\<neq\>1<rsub|T>>>|<row|<cell|>|<cell|>>|<row|<cell|Case1>|<cell|1<rsub|T>\<in\>range
        \<phi\>>>|<row|<cell|\<Rightarrow\>>|<cell|\<exists\>s<rsub|1>\<in\>S\<rightarrow\>s<rsub|1>\<phi\>=1<rsub|T>\<wedge\>s<rsub|1>\<neq\>1<rsub|S>>>|<row|<cell|\<Rightarrow\>>|<cell|\<forall\>s\<in\>S\<rightarrow\><around*|(|s|)>\<phi\>=1<rsub|T>\<phi\><around*|(|s|)>=<around*|(|s<rsub|1><rsub|>|)>\<phi\><around*|(|s|)>\<phi\>=<around*|(|s<rsub|1>s|)>\<phi\>=<around*|(|s
        s<rsub|1>|)>\<phi\>>>|<row|<cell|\<Rightarrow\>>|<cell|<around*|(|s<rsub|1>|)>\<phi\>=id<rsub|range
        \<phi\>>=<around*|(|1<rsub|S>|)>\<phi\>>>|<row|<cell|\<Rightarrow\>>|<cell|矛盾>>|<row|<cell|>|<cell|>>|<row|<cell|Case
        2>|<cell|1<rsub|T>\<nin\>range \<phi\>>>|<row|<cell|\<Rightarrow\>>|<cell|\<forall\>s\<in\>S,
        s\<phi\>\<neq\>1<rsub|T>>>|<row|<cell|>|<cell|X=range \<phi\>\<cup\>
        1<rsub|T>.<around*|(|1<rsub|S>\<neq\>1<rsub|T>,因此良定|)>>>|<row|<cell|\<Rightarrow\>>|<cell|X<rsup|2>\<subseteq\><choice|<tformat|<table|<row|<cell|range
        \<phi\>>|<cell|x<rsub|1>,x<rsub|2>\<in\>range
  ...
  <\definition>
    单态射(monomorphism<space|1em>单同态)

    <\equation*>
      <tabular*|<tformat|<table|<row|<cell|函数\<phi\>,定义域是S，值域是T,\<phi\>的像定义为<around*|{|s\<phi\>:s\<in\>S|}>>>|<row|<cell|若\<phi\>是单射<around*|(|one-one|)>，则\<phi\>称为单态射>>>>>
    </equation*>

    此定义等价于范畴定义:<math|\<phi\>>具有右消去律，也称<math|\<phi\>>是右可消去态射(right
    cancellative morphism)

    <\equation*>
      <tabular*|<tformat|<table|<row|<cell|\<phi\>:S\<rightarrow\>T,\<forall\>半群U,\<forall\>态射\<alpha\>,\<beta\>:U\<rightarrow\>S>>|<row|<cell|\<alpha\>\<phi\>=\<beta\>\<phi\>\<Rightarrow\>\<alpha\>=\<beta\>>>>>>
    </equation*>

    <\equation*>
      <tabular*|<tformat|<table|<row|<cell|>|<cell|\<phi\>单\<Rrightarrow\>\<alpha\>\<phi\>=\<beta\>\<phi\>\<rightarrow\>\<alpha\>=\<beta\>>>|<row|<cell|>|<cell|\<forall\>u\<in\>U,<around*|(|u\<alpha\>|)>\<phi\>=<around*|(|u\<beta\>|)>\<phi\>>>|<row|<cell|\<Rightarrow\>>|<cell|u\<alpha\>=u\<beta\>>>|<row|<cell|\<Rightarrow\>>|<cell|\<alpha\>=\<beta\>>>>>>
    </equation*>

    <\equation*>
      <tabular*|<tformat|<table|<row|<cell|>|<cell|\<forall\>U,\<forall\>\<alpha\>,\<beta\>:U\<rightarrow\>S,\<alpha\>\<phi\>=\<beta\>\<phi\>\<Rrightarrow\>\<phi\>单>>|<row|<cell|>|<cell|设\<phi\>不单>>|<row|<cell|>|<cell|选定U=S,
      \<alpha\>=\<beta\>=id<rsub|S>>>|<row|<cell|\<Rightarrow\>>|<cell|\<exists\>s<rsub|1>,s<rsub|2>.s<rsub|1>\<neq\>s<rsub|2>\<rightarrow\>s<rsub|1>\<phi\>=s<rsub|2>\<phi\>>>|<row|<cell|\<Rightarrow\>>|<cell|<around*|(|<around*|(|s<rsub|1>|)>\<alpha\>|)>\<phi\>=<around*|(|<around*|(|s<rsub|2>|)>\<beta\>|)>\<phi\>>>|<row|<cell|\<Rightarrow\>>|<cell|s<rsub|1>\<alpha\>=s<rsub|2>\<beta\>>>|<row|<cell|\<Rightarrow\>>|<cell|与\<alpha\>=\<beta\>=id<rsub|S>矛盾>>|<row|<cell|\<Rightarrow\>>|<cell|\<phi\>单>>>>>
    </equation*>
  </definition>
  ...
  <\definition>
    ...
    <\equation*>
      <tabular*|<tformat|<table|<row|<cell|态射\<phi\>:S\<rightarrow\>T,\<exists\>态射\<phi\><rsup|-1>\<rightarrow\>\<phi\>\<phi\><rsup|-1>=I<rsub|S>\<wedge\>\<phi\><rsup|-1>\<phi\>=I<rsub|T>>|<cell|s<around*|(|\<phi\>\<phi\><rsup|-1>|)>=t\<phi\><rsup|-1>=s>>>>>
    </equation*>

    根据定义

    <\equation*>
      <tabular*|<tformat|<table|<row|<cell|\<phi\>是同构\<Rightarrow\>\<phi\>是双射>>>>>
    </equation*>

    记号：若S和T之间存在一个同构映射<math|\<phi\>>.则称S与T同构.记为<math|S\<simeq\>T>
  </definition>

  <\definition>
    自同态(endomorphism)/自同构(automorphism)

    <\equation*>
      <tabular*|<tformat|<table|<row|<cell|自同态>|<cell|态射\<phi\>:S\<rightarrow\>S>>|<row|<cell|自同构>|<cell|同构\<phi\>:S\<rightarrow\>S>>>>>
    </equation*>
  </definition>

  <\definition>
    半群的直积(direct product)

    <\equation*>
      <tabular*|<tformat|<table|<row|<cell|S,T是半群>>|<row|<cell|S,T的笛卡尔积集S\<times\>T>>|<row|<cell|在S\<times\>T上定义乘法\<cdot\>>>|<row|<cell|\<cdot\>
      \ \ \ :<around*|(|s,t|)><around*|(|s<rprime|'>,t<rprime|'>|)>=<around*|(|s
      s<rprime|'>,t t<rprime|'>|)>>>|<row|<cell|易验证<around*|(|S\<times\>T,\<cdot\>|)>是半群，称为S和T的直积>>>>>
    </equation*>

    半群族的直积

    <\equation*>
      <tabular*|<tformat|<table|<row|<cell|半群族<around*|{|S<rsub|i>,i\<in\>I|}>>>|<row|<cell|直积的集合P=<around*|{|p<mid|\|>p:I\<rightarrow\>\<cup\><rsub|i\<in\>I>S<rsub|i>,i
      p\<in\>S<rsub|i>|}>>>|<row|<cell|乘法的分量形式：i<around*|(|p
  ...
  <\definition>
    对称群(symmetric group)、完全变换群(full transformation
    semigroup)

    <\equation*>
      <tabular*|<tformat|<table|<row|<cell|对称群>|<cell|\<cal-G\><rsub|X>\<assign\><around*|{|集合X的所有排列|}>>>|<row|<cell|>|<cell|\<assign\><around*|{|f\|f:X\<rightarrow\>X,f是双射|}>>>|<row|<cell|完全变换半群>|<cell|\<cal-T\><rsub|X>\<assign\><around*|{|f\|f:X\<rightarrow\>X|}>>>|<row|<cell|x\<in\>X>|<cell|x<around*|(|\<alpha\>\<circ\>\<beta\>|)>=x<around*|(|\<alpha\>\<beta\>|)>=<around*|(|x\<alpha\>|)>\<beta\>>>>>>
    </equation*>

    Remark:

    <\equation*>
      <tabular*|<tformat|<table|<row|<cell|\<cal-G\><rsub|X>是\<cal-T\><rsub|X>的子群>>|<row|<cell|如果
      X 是有限集, card X=n \ \ \ \ >>|<row|<cell|\<rightarrow\>card
      G<rsub|X>=n!, card \<cal-T\><rsub|X>=n<rsup|n>>>>>>
    </equation*>
  </definition>
  ...
  <\definition>
    ...
    <\equation*>
      <tabular*|<tformat|<table|<row|<cell|变换半群>|<cell|半群S\<subseteq\>\<cal-T\><rsub|X>>>|<row|<cell|S的<around*|(|映射|)>表示>|<cell|映射\<phi\>:S\<rightarrow\>\<cal-T\><rsub|X>>>|<row|<cell|S的忠实表示>|<cell|\<phi\>是单的>>>>>
    </equation*>
  ...
  <\theorem>
    若S是半群，<math|X=S<rsup|1>\<Rightarrow\>\<exists\>忠实表示\<phi\>:S\<rightarrow\>\<cal-T\><rsub|X>>
    ...
    <\proof>
      ...
      <\equation*>
        ...
        定义映射\<rho\><rsub|a>:S<rsup|1>\<rightarrow\>S<rsup|1>,x\<rho\><rsub|a>=x
        a<around*|(|x\<in\>S<rsup|1>|)>>>|<row|<cell|映射\<alpha\>:S\<rightarrow\>\<cal-T\><rsub|X>,
        ...
        a=x b>>|<row|<cell|\<Rightarrow\>1a=1b>>|<row|<cell|\<Rightarrow\>a=b>>|<row|<cell|\<Rightarrow\>\<alpha\>是单的>>|<row|<cell|\<rightarrow\>\<alpha\>是S的忠实表示>>>>>
      </equation*>

      根据定义的<math|\<rho\>>映射的性质
    ...
    Remark：类似于群的凯莱定理Cayley's Theorem

    此定理构造的忠实表示称为：S的右正则扩张表示(the
    extended right regular representation of S)

    证明中<math|S<rsup|1>>的条件1元是必要的，否则将可能产生非忠实表示（习题6）
  </theorem>
  ...
  <\theorem>
    ...
    <\proof>
      ...
      <\equation*>
        ...
        is one-one<around*|(|*单射|)>>>|<row|<cell|>|<cell|>>|<row|<cell|2>|<cell|\<forall\>a,b\<in\>S,<around*|(|a
...
<\auxiliary>
  <\collection>
    <\associate|toc>
      ...
      Sets, Semilattices and Lattices (半格、格)>
      ...
      <vspace*|1fn><with|font-series|<quote|bold>|math-font-series|<quote|bold>|5<space|2spc>Congruences(同余)>
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
